...
# Include the base system image in the swupdate image
SWUPDATE_IMAGES = "base-image-${MACHINE}"

python() {
  d.appendVarFlag("SWUPDATE_IMAGES_FSTYPES", f"base-image-{d.getVar('MACHINE')}", ".tar.gz")
}
